...
It modifies $CONFIG_ROOT/system.conf. As this is a generated file, 'set' also maintains a dropin file for the changes to remain.
...
Process:
 1. Read and merge files from  $DROPIN_DIR/type/*
 2. Write results to $CONFIG_ROOT and $BTC_BIN_DIR
 3. known types are "features", "properties" and "systems"
 4. 'es_systems.cfg' and 'es_features.cfg' go into $BTC_BIN_DIR
 5. 'system.conf', 'emulators.conf' and a handful of 'supported_*.json' go into $CONFIG_ROOT
