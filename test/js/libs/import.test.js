...
class ImportTests {
  ...
  static testGenerateConfig = parameterized(
    [
      {'--force': true, '-v': true, '--comment': 'Generated by test'},
      // without force, it should do nothing, so the new comment shouldn't apply
      {'-v': true, '--comment': 'Something else'}
    ], 
    function(options) {
